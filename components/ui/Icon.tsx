...
export default function Icon({ name, size = 18, style = {} }: IconProps) {
  ...
  switch (name) {
    ...
    case 'eye-off': return <svg {...props}><path d="M3 3l18 18"/><path d="M10.6 10.6A2 2 0 0 0 12 14a2 2 0 0 0 1.4-.6"/><path d="M9.9 4.4A10.8 10.8 0 0 1 12 4c6.5 0 10 8 10 8a18 18 0 0 1-3.1 4.2"/><path d="M6.6 6.6C3.7 8.7 2 12 2 12s3.5 8 10 8a10.7 10.7 0 0 0 5.4-1.5"/></svg>;
