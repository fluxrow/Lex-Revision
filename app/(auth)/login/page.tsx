...
export default function LoginPage() {
  ...
  return (
    <>
      ...
      <h2 style={{ fontSize: 26, fontWeight: 700, letterSpacing: '-0.02em', margin: '0 0 6px' }}>Bem-vindo de volta</h2>
      <p className="muted" style={{ margin: '0 0 28px', fontSize: 14 }}>Continue de onde parou</p>
      ...
      <p className="muted" style={{ textAlign: 'center', marginTop: 20, fontSize: 13 }}>
        Não tem conta? <Link href="/signup" style={{color:'var(--accent)', fontWeight: 600}}>Criar conta grátis</Link>
      </p>
    </>
  );
}
